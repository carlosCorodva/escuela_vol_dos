 ...
 * @author carlos
 */
public class MostrarEmpleadosReportesForm extends javax.swing.JDialog {
    ...
    public MostrarEmpleadosReportesForm(java.awt.Frame parent, boolean modal, JoinEmpleados usuario) {
        super(parent, modal);
        initComponents();
    ...
    public MostrarEmpleadosReportesForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
        ...
        try {
            if (evt.getClickCount() == 2) {
                ...
                if (objeto != null) {
                    ...
                    ActualizarEmpleadoReporteForm acc = new ActualizarEmpleadoReporteForm(new javax.swing.JFrame(), true,us, objeto);
                    acc.setVisible(true);
                    listar.clear();
            ...
            Logger.getLogger(MostrarEmpleadosReportesForm.class.getName()).log(Level.SEVERE, null, e);
        }
...
txtBuscar.setText(txtBuscar.getText().toUpperCase());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarEmpleadosReportesForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostrarEmpleadosReportesForm dialog = new MostrarEmpleadosReportesForm(new javax.swing.JFrame(), true);
