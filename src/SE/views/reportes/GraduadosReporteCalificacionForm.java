 ...
 * @author carlos
 */
public class GraduadosReporteCalificacionForm extends javax.swing.JDialog {
    ...
    public GraduadosReporteCalificacionForm(java.awt.Frame parent, boolean modal, JoinEmpleados usuario, JoinGraduados graduado) {
...
//        calcularPromedio();
    ...
    public GraduadosReporteCalificacionForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
    }
...
//    }
    ...
    public void imprimirPq() {
        ...
        try {
            ...
            Logger.getLogger(GraduadosReporteCalificacionForm.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GraduadosReporteCalificacionForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                GraduadosReporteCalificacionForm dialog = new GraduadosReporteCalificacionForm(new javax.swing.JFrame(), true);
