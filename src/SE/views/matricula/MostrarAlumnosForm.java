 ...
 * @author carlos
 */
public class MostrarAlumnosForm extends javax.swing.JDialog {
    ...
    public MostrarAlumnosForm(java.awt.Frame parent, boolean modal, JoinEmpleados usuario) {
        super(parent, modal);
        initComponents();
        us = usuario;
    ...
    public MostrarAlumnosForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        int r = JOptionPane.showConfirmDialog(null, "¿DESEA SALIR DEL MODULO ALUMNOS", "", JOptionPane.YES_NO_OPTION);
        ...
        try {
            if (evt.getClickCount() == 2) {
                ...
                if (objeto != null) {
                    ...
                    ActualizarAlumnosForm acc = new ActualizarAlumnosForm(new javax.swing.JFrame(), true, us, objeto);
                    acc.setVisible(true);
                    listar.clear();
            ...
            Logger.getLogger(MostrarAlumnosForm.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarAlumnosForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostrarAlumnosForm dialog = new MostrarAlumnosForm(new javax.swing.JFrame(), true);
