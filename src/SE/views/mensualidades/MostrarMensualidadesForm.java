 ...
 * @author carlos
 */
public class MostrarMensualidadesForm extends javax.swing.JDialog {
    ...
    public MostrarMensualidadesForm(java.awt.Frame parent, boolean modal, JoinEmpleados usuario) {
        super(parent, modal);
        initComponents();
        us = usuario;
...
//        cbFiltro.setSelectedIndex(0);
        ...
        try {
            if (evt.getClickCount() == 2) {
                ...
                if (objeto != null) {
                    ...
                    MensualidadMostrarForm acc = new MensualidadMostrarForm(new javax.swing.JFrame(), true, us, objeto);
                    acc.setVisible(true);
                    listar.clear();
                    cbFiltro.setSelectedIndex(0);
                    je.setId_empresa(Long.valueOf(lbEmpresa.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarMensualidadesForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MostrarMensualidadesForm dialog = new MostrarMensualidadesForm(new javax.swing.JFrame(), true);
